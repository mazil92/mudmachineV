 ...
 *
 * $Id: mextern.h,v 6.28 2021/09/25 3:00:00 develop TNL, HP, MP $
 *
 * $Log: mextern.h,v $
 *
10/01/2022:
...
extern int to_next_level( creature *ply_ptr, cmd *cmnd );
extern int say_hp( creature *ply_ptr, cmd *cmnd );
extern int say_mp( creature *ply_ptr, cmd *cmnd );
